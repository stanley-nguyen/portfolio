...
const projectData = [
    ...
    },
    {
        ...
        role: "Full Stack Developer",
        desc: "A cross-platform desktop app that lets users select a local music directory and play audio tracks. Built with ReactJS and Tauri, it features custom player controls, volume adjustment, and seek functionality. Used React Context for global state management.",
